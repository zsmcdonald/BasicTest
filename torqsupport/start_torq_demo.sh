...
echo 'Starting tp...'
nohup q ${TORQHOME}/torq.q -load ${TORQHOME}/code/processes/tickerplant.q -schemafile ${KDBTORQFSP}/database -tplogdir ${TORQHOME}/hdb ${KDBSTACKID} -proctype tickerplant -procname tickerplant1 -U ${KDBAPPCONFIG}/passwords/accesslist.txt -localtime </dev/null >$KDBLOG/torqtp.txt 2>&1 &
